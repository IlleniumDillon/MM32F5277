#ifndef _MM32_UART2REGDEF_H_
#define _MM32_UART2REGDEF_H_
...
}MM32_UART2_RXADDRBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_UART2_RXADDRBits B;
}MM32_UART2_RXADDR;
...
typedef struct
{
	...
	Strict_32Bit _reserved_0			:24;
}MM32_UART2_RXMASKBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_UART2_RXMASKBits B;
}MM32_UART2_RXMASK;
...
}MM32_UART2_ABRCRBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_UART2_ABRCRBits B;
}MM32_UART2_ABRCR;
