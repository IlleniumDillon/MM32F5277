#ifndef _MM32_UART1REGDEF_H_
#define _MM32_UART1REGDEF_H_
...
}MM32_UART1_RXADDRBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_UART1_RXADDRBits B;
}MM32_UART1_RXADDR;
...
typedef struct
{
	...
	Strict_32Bit _reserved_0			:24;
}MM32_UART1_RXMASKBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_UART1_RXMASKBits B;
}MM32_UART1_RXMASK;
...
}MM32_UART1_ABRCRBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_UART1_ABRCRBits B;
}MM32_UART1_ABRCR;
