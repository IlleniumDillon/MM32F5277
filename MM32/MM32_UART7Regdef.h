#ifndef _MM32_UART7REGDEF_H_
#define _MM32_UART7REGDEF_H_
...
}MM32_UART7_RXADDRBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_UART7_RXADDRBits B;
}MM32_UART7_RXADDR;
...
typedef struct
{
	...
	Strict_32Bit _reserved_0			:24;
}MM32_UART7_RXMASKBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_UART7_RXMASKBits B;
}MM32_UART7_RXMASK;
...
}MM32_UART7_ABRCRBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_UART7_ABRCRBits B;
}MM32_UART7_ABRCR;
