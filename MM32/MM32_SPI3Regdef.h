#ifndef _MM32_SPI3REGDEF_H_
#define _MM32_SPI3REGDEF_H_
...
}MM32_SPI3_I2S_TXREGBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_SPI3_I2S_TXREGBits B;
}MM32_SPI3_I2S_TXREG;
...
}MM32_SPI3_I2S_RXREGBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_SPI3_I2S_RXREGBits B;
}MM32_SPI3_I2S_RXREG;
...
}MM32_SPI3_I2S_CSTATBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_SPI3_I2S_CSTATBits B;
}MM32_SPI3_I2S_CSTAT;
...
}MM32_SPI3_I2S_INTSTATBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_SPI3_I2S_INTSTATBits B;
}MM32_SPI3_I2S_INTSTAT;
...
typedef struct
{
	...
	Strict_32Bit _reserved_0			:24;
}MM32_SPI3_I2S_INTENBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_SPI3_I2S_INTENBits B;
}MM32_SPI3_I2S_INTEN;
...
typedef struct
{
	...
	Strict_32Bit _reserved_0			:24;
}MM32_SPI3_I2S_INTCLRBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_SPI3_I2S_INTCLRBits B;
}MM32_SPI3_I2S_INTCLR;
...
}MM32_SPI3_I2S_GCTLBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_SPI3_I2S_GCTLBits B;
}MM32_SPI3_I2S_GCTL;
...
}MM32_SPI3_I2S_CCTLBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_SPI3_I2S_CCTLBits B;
}MM32_SPI3_I2S_CCTL;
...
}MM32_SPI3_I2S_SPBRGBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_SPI3_I2S_SPBRGBits B;
}MM32_SPI3_I2S_SPBRG;
...
typedef struct
{
	...
	Strict_32Bit _reserved_0			:16;
}MM32_SPI3_I2S_RXDNRBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_SPI3_I2S_RXDNRBits B;
}MM32_SPI3_I2S_RXDNR;
...
}MM32_SPI3_I2S_NSSRBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_SPI3_I2S_NSSRBits B;
}MM32_SPI3_I2S_NSSR;
...
}MM32_SPI3_I2S_EXTCTLBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_SPI3_I2S_EXTCTLBits B;
}MM32_SPI3_I2S_EXTCTL;
...
}MM32_SPI3_I2S_I2SCFGRBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_SPI3_I2S_I2SCFGRBits B;
}MM32_SPI3_I2S_I2SCFGR;
