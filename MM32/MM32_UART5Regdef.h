#ifndef _MM32_UART5REGDEF_H_
#define _MM32_UART5REGDEF_H_
...
}MM32_UART5_RXADDRBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_UART5_RXADDRBits B;
}MM32_UART5_RXADDR;
...
typedef struct
{
	...
	Strict_32Bit _reserved_0			:24;
}MM32_UART5_RXMASKBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_UART5_RXMASKBits B;
}MM32_UART5_RXMASK;
...
}MM32_UART5_ABRCRBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_UART5_ABRCRBits B;
}MM32_UART5_ABRCR;
