#ifndef _MM32_UART4REGDEF_H_
#define _MM32_UART4REGDEF_H_
...
}MM32_UART4_RXADDRBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_UART4_RXADDRBits B;
}MM32_UART4_RXADDR;
...
typedef struct
{
	...
	Strict_32Bit _reserved_0			:24;
}MM32_UART4_RXMASKBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_UART4_RXMASKBits B;
}MM32_UART4_RXMASK;
...
}MM32_UART4_ABRCRBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_UART4_ABRCRBits B;
}MM32_UART4_ABRCR;
