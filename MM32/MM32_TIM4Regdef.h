#ifndef _MM32_TIM4REGDEF_H_
#define _MM32_TIM4REGDEF_H_
...
typedef struct
{
	...
	Strict_32Bit _reserved_0			:16;
}MM32_TIM4_CCMR1_OutputBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_TIM4_CCMR1_OutputBits B;
}MM32_TIM4_CCMR1_Output;
...
typedef struct
{
	...
	Strict_32Bit IC2F			:4;
	Strict_32Bit _reserved_0			:16;
}MM32_TIM4_CCMR1_InputBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_TIM4_CCMR1_InputBits B;
}MM32_TIM4_CCMR1_Input;
...
typedef struct
{
	...
	Strict_32Bit _reserved_0			:16;
}MM32_TIM4_CCMR2_OutputBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_TIM4_CCMR2_OutputBits B;
}MM32_TIM4_CCMR2_Output;
...
typedef struct
{
	...
	Strict_32Bit IC4F			:4;
	Strict_32Bit _reserved_0			:16;
}MM32_TIM4_CCMR2_InputBits;

typedef union
{
	int32_t I;
	uint32_t U;
	MM32_TIM4_CCMR2_InputBits B;
}MM32_TIM4_CCMR2_Input;
